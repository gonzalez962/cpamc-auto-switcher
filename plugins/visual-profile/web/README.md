...
- **Graph & Prefix Coherence Invariants**:
  ...
  - **Saved Graph Baseline Synchronization**: After successful saves, the reset baseline is synchronized with the newly saved prefixes, ensuring Reset restores the saved baseline rather than reverting to stale initial props from before save.
